...
// explicit props to ensure `payload`, `label`, and `labelClassName` are recognized by TypeScript
type ChartTooltipContentProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  labelKey?: string;
  color?: string;
  labelClassName?: string; // ADDED: declare labelClassName used in component
};
...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    const payload = (rawPayload as Array<any> | undefined) ?? undefined;
